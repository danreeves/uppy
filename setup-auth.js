...
async function setupAuth() {
  try {
    console.log(
      'This script will help you set up a secure admin password for your uptime checker.\n'
    );
    ...
    if (method === '1') {
      ...
      console.log(
        '   Your password is stored in .dev.vars (excluded from git)'
      );
      ...
      try {
        ...
        execSync(`npx wrangler secret put ADMIN_PASSWORD`, {
          stdio: 'inherit',
        });
